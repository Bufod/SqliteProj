...
public class DBMatches {
    ...
    class TableMatches{
        ...
        public long insert(String teamhouse, String teamguest,
                           int goalshouse, int goalsguest) {
        ...
        public int update(Matches md) {
            ...
            return mDataBase.update(TABLE_NAME, cv,
                    COLUMN_ID + " = ?",
    ...
    private class OpenHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            String query = "CREATE TABLE " + TableMatches.TABLE_NAME + " (" +
                    TableMatches.COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                    TableMatches.COLUMN_TEAMHOME+ " TEXT, " +
                    TableMatches.COLUMN_TEAMGUAST + " TEXT, " +
                    TableMatches.COLUMN_GOALSHOME + " INT,"+
                    TableMatches.COLUMN_GOALSGUAST+" INT);";
            db.execSQL(query);
        }

        @Override
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            db.execSQL("DROP TABLE IF EXISTS " + TableMatches.TABLE_NAME);
            onCreate(db);
        }
    }
